...
import style from "./style_newsletter.module.css";
...
export const Newsletter = () => {
    ...
    return (
        <>
            ...
            <img className={style.image_bee_newsletter} src="/bee_newsletter.svg" alt="image"/>
            ...
            <Card className={`w-1/2 h-1/2 ml-72 `}>
                <CardBody className='flex flex-col justify-center items-start px-16 py-14 max-lg:px-12 max-lg:py-10'>
                    <h3 className='text-5xl max-md:text-3xl font-semibold tracking-wide antialiased mb-10 max-md:mb-5 text-gray-800'>Rejoignez
                        la danse des abeilles !</h3>
                    <p><span
                        className='text-left font-normal tracking-normal text-lg max-md:text-base text-gray-700/50'>Soyez toujours informés de nos actions </span>
                    </p>
                    <div
                    ...
                    <div className='flex max-md:flex-col flex-row justify-center items-center w-full'>
